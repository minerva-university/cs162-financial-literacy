# test_posts.py
# Since we now rely on app.session_factory = db_session, we do not need to monkeypatch Session in test_posts.py.
...
class TestPosts:
    """
    Tests for posts-related endpoints. 
    The client and db_session fixtures ensure a clean in-memory database and authenticated session if needed.
    """
